...
<html lang="en">
<head>
  <title>PRODUCTOS ANULADOS</title>
  <meta charset="utf-8">
...
<nav role="navigation" class="navbar navbar-default navbar-fixed-top">
  ...
  <center>        
        ...
        <button id="bt-buscaranulados" class="btn btn-primary">Buscar</button>
        <a target="_blank" href="javascript:buscaranulados();" class="btn btn-success">Excel</a>
      </center>
    </form>      
</div>
</br>
