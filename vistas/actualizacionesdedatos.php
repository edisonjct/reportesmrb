...
<html lang="en">
<head>
  <title>SIN CUENTAS CONTABLES</title>
  <meta charset="utf-8">
  ...
  <center>        
        <div class="form-group">                        
            <select required="required" id="cb-bodega" class="form-control">                                                                
                                ...
                                <option value="KIWY">KIWY</option>
                                <option value="PACO">PACO</option>
                                <option value="SUAKASA">SUAKASA</option>
                </select></td>
        </div>        
        <button id="bt-buscarproductossn" class="btn btn-primary">Buscar</button>
        <a target="_blank" href="javascript:reporteSINACT();" class="btn btn-success">Excel</a>
      </center>
    </form>      
</div>
</br>
