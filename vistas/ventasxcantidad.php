    ...
    <body>
        ...
        <form class="form-inline" role="form" method="GET">
            <center>
                ...
                <div class="form-group">                        
                    <select required="required" id="cb-bodega" class="selectpicker" data-actions-box="true" data-live-search="true" title="Selecione Bodegas">                        
                        <?php
                ...
                <button id="bt-buscar2" class="btn btn-primary">Buscar</button>
                <td width="50"><a target="_blank" href="javascript:reporteEXCEL();" class="btn btn-success">Excel</a>
            </center>
        </form>      
    </div>
    </br>
