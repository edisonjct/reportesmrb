...
<html lang="en">
    <head>
        <title>VENTAS POR ARCHIVO</title>
       <meta charset="utf-8">
    ...
    <body>
        ...
        <form class="form-inline" role="form" enctype="multipart/form-data" id="subida" method="post">
            <center>
                ...
                <div class="form-group">
                    <label>Desde</label>
                    <input required="required" type="date" class="form-control" id="bd-desde" name="desde" />
                </div>
                <div class="form-group">
                    <label>Hasta</label>
                    <input required="required" type="date" class="form-control" id="bd-hasta" name="hasta" />
                </div>        
                <button id="bt-ventaxarchivo" class="btn btn-primary">Procesar</button>        
