        ...
        <form class="form-inline" role="form" method="GET" id="busqueda">
            <center>
                <div class="form-group">                        
                    <input required="required" type="text" id="txt-codigo" class="form-control" placeholder="Ingrese el Codigo" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Desde</label>
                    <input required="required" type="date" class="form-control" id="bd-desde"/>
                </div>
                <div class="form-group">
                    <label>Hasta</label>
                    <input required="required" type="date" class="form-control" id="bd-hasta"/>
                </div>        
                <button id="bt-kardex" class="btn btn-primary">Procesar</button>        
