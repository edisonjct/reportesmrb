        ...
        <form class="form-inline" role="form" method="GET" id="busqueda">
            <center>    
                <div class="form-group">                        
                    <select required="required" id="cb-vendedores" class="selectpicker" multiple data-actions-box="true" data-live-search="true" data-selected-text-format="count > 3" title="Selecione Vededor">
                        <?php
                        $query = mysql_query("select codtab,nomtab from maetab WHERE numtab = '73' AND codtab != '' ORDER BY nomtab ASC");
                ...
                <button id="bt-vendedores" class="btn btn-primary">Buscar</button>        
