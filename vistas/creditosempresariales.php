...
<nav role="navigation" class="navbar navbar-default navbar-fixed-top">
  ...
  <center>   
        <div class="form-group">  
          <label>Tipo</label>          
           <select required="required" class="form-control" id="cb-tipo">                                                                
                  <option value="80">FACTURAS</option>
                  <option value="22">NOTAS DE CREDITO</option>                  
            </select>
        </div>  
        <div class="form-group">  
          <label>Categoria</label>          
           <select required="required" class="form-control" id="cb-categoria">                                                                
                  <option value="TODOS">TODOS</option>
                  <option value="0004">EMPLEADOS</option>
                  <option value="0008">EX EMPLEADOS</option>                                
            </select>
        </div>    
        <div class="form-group">
            <label>Desde</label>
        ...
        <a target="_blank" href="javascript:reporteCREDITOSEMP();" class="btn btn-success">Excel</a>
      </center>
    </form>      
</div>
</br>
