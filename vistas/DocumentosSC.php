...
<html lang="en">
    <head>
        <title>SUPER DE COMPANIAS</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <form class="form-inline" role="form" method="GET">
            <center>   
                ...
                <div class="form-group">                        
                    <select id="cb-bodega" class="selectpicker" multiple data-actions-box="true" data-selected-text-format="count > 3 data-toggle="tooltip" title="Bodegas" data-width="200px">
                        <?php
                ...
                <button id="bt-docsc" class="btn btn-primary">Buscar</button>
                <a target="_blank" href="javascript:excelsupercontrol();" class="btn btn-success">Excel</a>
            </center>
        </form>      
        <br>
        <div>
