...
"
		...
		$mail->AltBody = 'Correo Enviado Automaticamente'; // Opcional-MsgHTML crea uno alternativo
		$mail->IsHTML(false);
		$body  = '<table class="table table-striped table-condensed table-hover">
			...
			$mail->CharSet ="UTF-8";			
			$mail->Send();
			echo '<div align="center">ENVIADO CORRECTAMENTE</div>';
		} else { echo '<div align="center">NO HAY DATOS QUE ENVIAR</div>'; }
