...
d.bodega as bodega,
(CASE WHEN (d.bodega = '01') THEN Sum(d.CANTID03)	ELSE '0' END) AS MATRIZ,
(CASE WHEN (d.bodega = '03') THEN Sum(d.CANTID03)	ELSE '0' END) AS JARDIN,
(CASE WHEN (d.bodega = '05') THEN Sum(d.CANTID03)	ELSE '0' END) AS CONDADO,
(CASE WHEN (d.bodega = '06') THEN Sum(d.CANTID03)	ELSE '0' END) AS SCALA,
(CASE WHEN (d.bodega = '04') THEN Sum(d.CANTID03)	ELSE '0' END) AS SOL,
(CASE WHEN (d.bodega = '07') THEN Sum(d.CANTID03)	ELSE '0' END) AS VILLAGE,
(CASE WHEN (d.bodega = '16') THEN Sum(d.CANTID03)	ELSE '0' END) AS QUICENTRO,
(CASE WHEN (d.bodega = '15') THEN Sum(d.CANTID03)	ELSE '0' END) AS 'SLUIS',
(CASE WHEN (d.bodega = '14') THEN Sum(d.CANTID03)	ELSE '0' END) AS 'SMARINO',
(CASE WHEN (d.bodega = '13') THEN Sum(d.CANTID03)	ELSE '0' END) AS CUMBAYA,
(CASE WHEN (d.bodega = '17') THEN Sum(d.CANTID03)	ELSE '0' END) AS 'JLMERA',
(CASE WHEN (d.bodega = '02') THEN Sum(d.CANTID03)	ELSE '0' END) AS WEB,
(CASE WHEN (d.bodega = '09') THEN Sum(d.CANTID03)	ELSE '0' END) AS EVENTOS
FROM
